...
//             ESP_LOGI(TAG, "Buffer full. Evicting oldest timestamp=%" PRIu32, oldest->timestamp);
...
//                 ESP_LOGI(TAG, "Evicted data stored to flash. timestamp=%" PRIu32, oldest->timestamp);
//             } else {
//                 ESP_LOGE(TAG, "Failed to store measurement in flash during eviction");
//             }
//         } else {
//             ESP_LOGI(TAG, "Buffer full. Evicting oldest timestamp=%" PRIu32 " which is already in flash or edge", oldest->timestamp);
//         }
